(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".clothing__slider")) new Swiper(".clothing__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
        ...
        if (document.querySelector(".our-instagram__slider")) new Swiper(".our-instagram__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
    ...
    document.addEventListener("click", (e => {
        ...
        if (targetElement.closest(".phone-links__current")) targetElement.closest(".phone-links").classList.toggle("is-open");
        if (!targetElement.closest(".phone-links__current")) removeClasses(document.querySelectorAll(".phone-links.is-open"), "is-open");
    }));
    isWebp();
    menuInit();
})();